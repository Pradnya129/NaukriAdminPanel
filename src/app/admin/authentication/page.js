...
export const metadata = { title: 'Authentication - Jobbox Admin' }
...
<div className="box-heading">
        <div className="box-title">
          <h3 className="mb-35">Authentication</h3>
        </div>
                      ...
                      <div className="col-lg-4 col-md-6 col-sm-12 mx-auto">
                        <div className="form-login-cover">
                          ...
                          <form className="login-register text-start mt-20" action="#">
                            ...
                            <div className="text-muted text-center">Don't Have Passoword?<a href="/contact">Contact Us</a></div>
                          </form>
                        </div>
                      </div>
                    </div>
