...
export const metadata = { title: 'Profile - Jobbox Admin' }
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-12">
                      <div className="form-group mb-30">
                        ...
                        <textarea className="form-control" name="message" rows="5"  defaultValue="We are AliThemes , a creative and dedicated group of individuals who love web development almost as much as we love our customers. We are passionate team with the mission for achieving the perfection in web design."></textarea>
                      </div>
                    </div>
                    <div className="col-lg-6 col-md-6">
                      <div className="form-group mb-30">
